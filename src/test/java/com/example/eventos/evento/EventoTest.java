...
class EventoTest {
    ...
    public void initEach(){
        ...
        eventoSimple = new Evento("Boda", "Cena", new Personas(150, 10), "Aielo de Malferit", fecha, "Boda-Cena", "Sala1");
        eventoNoProtagonistas = new Evento("id2", "Boda", "Cena", new Personas(150, 10), "Aielo de Malferit", fecha, "Boda-Cena", "Sala1");
        eventoProtagonistas = new Evento("id", "Comunión", "Comida", new Personas(50, 15), "Olleria", fecha, 80, 15, true, protagonistas, "Comunión-Comida", "Sala1", new Distribucion("Distribucion"));
    }
    ...
    void equalsTestFalseTipo(){
        Evento evento1 = new Evento("Boda", "Cena", new Personas(150, 10), "Aielo de Malferit", fecha, "Boda-Cena", "Sala1");
        Evento evento2 = new Evento("Boda", "Cena", new Personas(150, 10), "Aielo de Malferit", fecha, "Boda-Cena", "Sala1");
