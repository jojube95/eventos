...
class MesaRestControllerTest {
    ...
    void addTestAdmin() throws Exception {
        Evento evento = new Evento("eventoId", "Comunion", "Comida", new Personas(50, 15), "Olleria", new GregorianCalendar(2010, Calendar.FEBRUARY, 3).getTime(), 80, 15, true, new ArrayList<>(), "Comunión-Comida", "Sala1", new Distribucion("Distribucion"));
