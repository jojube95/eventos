...
public class Constants {
    ...
    public static final String EMPLEADO_UPDATE_PAGE = "empleadoUpdate";
    public static final String EMPLEADO_HISTORIAL_PAGE = "empleadoHistorial";
    ...
    public static final String ATTRIBUTE_IS_EVENTO_WITH_MESAS_CON_RESERVA = "isEventoWithMesasConReserva";
