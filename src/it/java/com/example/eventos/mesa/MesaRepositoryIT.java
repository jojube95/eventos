...
class MesaRepositoryIT {
    ...
    @BeforeEach
    public void setUp(){
        Mesa mesa0 = new Mesa("id0", "idEvento1", "Pepe", new Personas(10, 2), 3, true, "descripcion");
        Mesa mesa1 = new Mesa("id1", "idEvento1", "Pepe", new Personas(10, 2), 1, true, "descripcion");
        Mesa mesa2 = new Mesa("id2", "idEvento1", "Antonio", new Personas(8, 2), 2, false, "descripcion");
        Mesa mesa3 = new Mesa("id3", "idEvento2", new Personas(6, 1), 1, "descripcion");
        Mesa mesa4 = new Mesa("id123", "idEvento2", new Personas(4, 1), 2, "descripcion");
    ...
    @Test
    void saveTest(){
        Mesa mesaExpected = new Mesa("idEvento3", "Jose", new Personas(10, 1), 1, true, "descripcion");
