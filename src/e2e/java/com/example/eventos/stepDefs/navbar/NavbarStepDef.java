...
public class NavbarStepDef {
    ...
    public void redirect_to_anyadir_empleados_page(){
        ...
        wait.until(ExpectedConditions.urlToBe("http://localhost:8080/empleadoAnyadir"));
    }
    ...
    public void redirect_to_barras_page(){
        WebDriverWait wait = new WebDriverWait(connector.getDriver(), Duration.ofSeconds(2));
        wait.until(ExpectedConditions.urlToBe("http://localhost:8080/graficoBarras"));
    }

    @Then("^Ver tarta page is shown$")
    public void redirect_to_tarta_page(){
        WebDriverWait wait = new WebDriverWait(connector.getDriver(), Duration.ofSeconds(2));
        wait.until(ExpectedConditions.urlToBe("http://localhost:8080/graficoPastel"));
    }

    @Then("^Ver dispersion page is shown$")
    public void redirect_to_dispersion_page(){
        WebDriverWait wait = new WebDriverWait(connector.getDriver(), Duration.ofSeconds(2));
        wait.until(ExpectedConditions.urlToBe("http://localhost:8080/graficoDispersion"));
    }
