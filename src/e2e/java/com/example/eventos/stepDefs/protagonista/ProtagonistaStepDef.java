...
public class ProtagonistaStepDef {
    ...
    public void visit_ver_eventos_page() {
        ...
        connector.getDriver().get("http://localhost:8080/evento/protagonistas?eventoId=62dc2a63ec628818203950b9");
    }
    ...
    public void redirect_to_add_protagonista_page(){
        ...
        wait.until(ExpectedConditions.urlToBe("http://localhost:8080/evento/protagonistas/anyadir?eventoId=62dc2a63ec628818203950b9"));
    }
